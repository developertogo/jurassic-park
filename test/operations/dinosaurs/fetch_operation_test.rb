...
module Dinosaurs
  class FetchOperationTest < ActiveSupport::TestCase
    test 'should pass contract validation then calling the service' do
      ...
      operation = Dinosaurs::FetchOperation.new(params: params_mock).call
    ...
    test 'should return errors if something goes wrong while validating params' do
      service_mock = mock
      Dinosaurs::FetchService.expects(:new).returns(service_mock).never

      operation = Dinosaurs::FetchOperation.new(params: {}).call
